                        ...
                        {adapterType === "cursor" || adapterType === "codex_local" || adapterType === "opencode_local" ? (
                          <p className="text-muted-foreground">
                            {adapterType === "codex_local"
                              ? (
                                <>
                                  If auth fails, set <span className="font-mono">OPENAI_API_KEY</span>, run{" "}
                                  <span className="font-mono">codex login</span>, or point the adapter env to a
                                  session pool with <span className="font-mono">PAPERCLIP_CODEX_SESSION_POOL_FILE</span>{" "}
                                  and <span className="font-mono">PAPERCLIP_CODEX_SESSION_STORE_DIR</span>.
                                </>
                              )
                              : (
                                <>
                                  ...
                                  in env or run{" "}
                                  <span className="font-mono">
                                    {adapterType === "cursor" ? "agent login" : "opencode auth login"}
                                  </span>.
                                </>
                              )}
                          </p>
